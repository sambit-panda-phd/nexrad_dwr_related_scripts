# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 09:39:11 2019
...
sacloc = os.getcwd()+"\hydroclass_v2_allvar\hydrolabel1"
...
np.savetxt('new_common_labels_20170826.txt', cid_array)    
np.savetxt('new_nexrad_hid_counts_20170826.txt', hid_array)
np.savetxt('new_sac_hid_counts_20170826.txt', sac_array)
np.savetxt('new_time_list.txt', time_array,fmt='%s')
